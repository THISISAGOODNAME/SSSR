...
{
    m_program.vs.cbuffer.ConstantBuf.projection = glm::transpose(m_input.camera.getProjMatrix());
...
void BackgroundPass::OnModifySSSRSettings(const SSSRSettings &settings)
{
    m_settings = settings;
}
